...
describe('the app process reads a page without running its code', () => {
  ...
  it('refuses a redirect that lands off the approved origin', async () => {
    // The gap the allowlist cannot see: it checked the URL we ASKED for. The
    // worker's fetcher makes the same check for the same reason.
