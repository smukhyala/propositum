...
| **A thread on your phone, optional, off unless you connect it** | If you pair one, Propositum sends you **derived prose about your own work** — a subject, why it is offering, why it stopped, what it needs decided — and, since 2026-09-03, that it stopped seeing your work while you were away, which is a timestamp of your machine sleeping or the extension dying, on somebody else's server. That is the point of the channel and it is also a sentence about your life on somebody else's server. The bot is **yours**: you create it, we never see it, and there is no shared bot and no operator. The messages are **not end-to-end encrypted** |
